...
func (dm_build_1457 *dm_build_1345) dm_build_1456(dm_build_1458 *DmStatement, dm_build_1459 []parameter) error {
...
func (dm_build_1465 *dm_build_1345) Dm_build_1464(dm_build_1466 *DmStatement, dm_build_1467 []interface{}, dm_build_1468 bool) (*execRetInfo, error) {
	...
	for icol := 0; icol < int(dm_build_1466.paramCount); icol++ {
		...
		if dm_build_1465.dm_build_1590(dm_build_1469, dm_build_1467, icol) {
			...
			if !dm_build_1468 {
				dm_build_1465.dm_build_1456(dm_build_1466, dm_build_1466.bindParams)

				dm_build_1468 = true
			}

			dm_build_1465.dm_build_1596(dm_build_1466, dm_build_1466.bindParams[icol], icol, dm_build_1467[icol].(iOffRowBinder))
			dm_build_1469[icol] = ParamDataEnum_OFF_ROW
		}
	}

	var dm_build_1470 = make([][]interface{}, 1, 1)
...
func (dm_build_1597 *dm_build_1345) dm_build_1596(dm_build_1598 *DmStatement, dm_build_1599 parameter, dm_build_1600 int, dm_build_1601 iOffRowBinder) error {
